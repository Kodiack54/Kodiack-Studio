...
server.setRequestHandler(ListToolsRequestSchema, async () => ({
  tools: [
    ...
    { name: 'server_claude_connect', description: 'Connect to the server-side Claude terminal at :5400. Call this before sending commands.', inputSchema: { type: 'object', properties: { project: { type: 'string', description: 'Project path on the server (defaults to dev-studio-5000)' } } } },
